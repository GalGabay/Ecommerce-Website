...
const getProducts = asyncHandler(async (req,res) => {
    const pageSize = 8; // how many products are gonna be in one page
    ...
    .limit(pageSize) // limit the number of products in the page
    .skip(pageSize * (page - 1)); // skip the products in the previous pages.
